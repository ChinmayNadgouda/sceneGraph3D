...
class ReplicaDataset(GradSLAMDataset):
    def __init__(
        ...
        **kwargs,
        ...
        self.input_folder = os.path.join(basedir, sequence)
        self.pose_path = os.path.join(self.input_folder, "nerf.txt")
        super().__init__(
            config_dict,
            stride=stride,
            start=start,
...
class SIRDataset(GradSLAMDataset):
    def __init__(self,
        config_dict,
        basedir,
        sequence,
...
def get_dataset(dataconfig, basedir, sequence, **kwargs):
    ...
    elif config_dict['dataset_name'].lower() in ["sirdataset"]:
        return SIRDataset(config_dict, basedir, sequence, **kwargs)
    else:
